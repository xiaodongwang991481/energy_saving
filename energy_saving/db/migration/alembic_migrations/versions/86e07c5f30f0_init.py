...
def upgrade():
    ...
    sa.Column('name', sa.String(length=36), nullable=False),
    sa.ForeignKeyConstraint(['datacenter_name', 'energy_optimazation_target_name'], ['energy_optimazation_target.datacenter_name', 'energy_optimazation_target.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name'], ['datacenter.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('datacenter_name', 'energy_optimazation_target_name', 'name')
    )
    ...
    sa.Column('controller_name', sa.String(length=36), nullable=False),
    sa.Column('controller_parameter_name', sa.String(length=36), nullable=False),
    sa.ForeignKeyConstraint(['datacenter_name', 'controller_name', 'controller_parameter_name'], ['controller_parameter_data.datacenter_name', 'controller_parameter_data.controller_name', 'controller_parameter_data.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name', 'controller_name'], ['controller.datacenter_name', 'controller.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name', 'controller_parameter_name'], ['controller_parameter.datacenter_name', 'controller_parameter.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name', 'prediction_name'], ['prediction.datacenter_name', 'prediction.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name'], ['datacenter.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('datacenter_name', 'prediction_name', 'controller_name', 'controller_parameter_name')
    )
    op.create_table('energy_optimazation_target_prediction',
    sa.Column('datacenter_name', sa.String(length=36), nullable=False),
    sa.Column('prediction_name', sa.String(length=36), nullable=False),
    sa.Column('energy_optimazation_target_name', sa.String(length=36), nullable=False),
    sa.Column('energy_optimazation_target_data_name', sa.String(length=36), nullable=False),
    sa.ForeignKeyConstraint(['datacenter_name', 'energy_optimazation_target_name', 'energy_optimazation_target_data_name'], ['energy_optimazation_target_data.datacenter_name', 'energy_optimazation_target_data.energy_optimazation_target_name', 'energy_optimazation_target_data.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name', 'energy_optimazation_target_name'], ['energy_optimazation_target.datacenter_name', 'energy_optimazation_target.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name', 'prediction_name'], ['prediction.datacenter_name', 'prediction.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name'], ['datacenter.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('datacenter_name', 'prediction_name', 'energy_optimazation_target_name', 'energy_optimazation_target_data_name')
    )
    op.create_table('sensor_attribute_prediction',
    sa.Column('datacenter_name', sa.String(length=36), nullable=False),
    sa.Column('prediction_name', sa.String(length=36), nullable=False),
    sa.Column('sensor_name', sa.String(length=36), nullable=False),
    sa.Column('sensor_attribute_name', sa.String(length=36), nullable=False),
    sa.ForeignKeyConstraint(['datacenter_name', 'prediction_name'], ['prediction.datacenter_name', 'prediction.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name', 'sensor_attribute_name'], ['sensor_attribute.datacenter_name', 'sensor_attribute.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name', 'sensor_name', 'sensor_attribute_name'], ['sensor_attribute_data.datacenter_name', 'sensor_attribute_data.sensor_name', 'sensor_attribute_data.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name', 'sensor_name'], ['sensor.datacenter_name', 'sensor.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['datacenter_name'], ['datacenter.name'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('datacenter_name', 'prediction_name', 'sensor_name', 'sensor_attribute_name')
    )
